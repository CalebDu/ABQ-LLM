...
int main(int argc, char **argv)
{
    ...
    case 2:
        switch (w_bits) {
        case 2:
            test_cute_w2a2(x_bits, w_bits, d_x, d_w, d_x_pack, d_w_pack, m, n, k, d_out, h_out,
    ...
    case 8:
        switch (w_bits) {
            ...
            //     break;
            // case 4:
            //     test_cute_w4a8(x_bits, w_bits, d_x, d_w, d_x_pack, d_w_pack, m, n, k, d_out, h_out,
            //                   h_ref_out, warmup, repeat, quant_sign, stream);
            //     break;
            // case 8:
            //     test_cute_w8a8(x_bits, w_bits, d_x, d_w, d_x_pack, d_w_pack, m, n, k, d_out, h_out,
            //                   h_ref_out, warmup, repeat, quant_sign, stream);
            //     break;
