                    ...
                    bool quant_sign, cudaStream_t stream)
{
    ...
    if (quant_sign) {
        ...
        TEST(4, 4, true, 2, 64, 1024, 1, 4, 1, 8, 8, 128, 3);
        TEST(4, 4, true, 2, 32, 512, 1, 4, 1, 8, 8, 128, 8);
        TEST(4, 4, true, 2, 64, 512, 1, 4, 1, 8, 8, 128, 6);
        TEST(4, 4, true, 2, 32, 1024, 1, 4, 1, 8, 8, 128, 4);
    } else {
    }
