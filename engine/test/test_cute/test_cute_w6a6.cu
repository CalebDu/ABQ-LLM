                    ...
                    bool quant_sign, cudaStream_t stream)
{
    ...
    if (quant_sign) {
        ...
        TEST(6, 6, true, 1, 64, 1024, 1, 4, 1, 8, 8, 128, 2);
        TEST(6, 6, true, 1, 64, 512, 1, 4, 1, 8, 8, 128, 4);

        TEST(6, 6, true, 1, 32, 512, 1, 4, 1, 8, 8, 128, 7);

        TEST(6, 6, true, 1, 32, 512, 1, 4, 1, 8, 8, 128, 4);
        TEST(6, 6, true, 1, 32, 1024, 1, 4, 1, 8, 8, 128, 3);
    } else {
    }
